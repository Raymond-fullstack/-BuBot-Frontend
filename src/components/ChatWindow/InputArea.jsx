...
export function InputArea({ conversationId, onSendMessage }) {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-surface-container-lowest shadow-lg border border-outline-variant/10 rounded-[2rem] p-2 flex items-center gap-2 pl-6">
          ...
          <div className="flex items-center gap-1 pr-2">
            ...
            <button 
              onClick={handleSend}
              className="w-12 h-12 rounded-full bg-tertiary text-white flex items-center justify-center hover:opacity-90 transition-all shadow-md active:scale-95"
            >
