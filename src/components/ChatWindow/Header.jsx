  ...
  return (
    <header className="h-16 flex justify-between items-center px-8 bg-surface/80 backdrop-blur-md sticky top-0 z-10">
      <div className="flex flex-col">
        <h2 className="text-lg font-bold text-on-surface font-headline tracking-tight">BuBot – Busitema Assistant Chatbot</h2>
        <p className="text-[10px] text-secondary font-medium">Helping you navigate campus life with ease.</p>
      </div>
      <div className="flex items-center gap-4">
        ...
        <button className="flex items-center gap-2 p-1 pl-3 border border-outline-variant/20 rounded-full hover:bg-surface-container-low transition-colors">
          <span className="text-xs font-semibold text-on-surface">Someone</span>
